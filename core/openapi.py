...
class DashboardStatisticsSerializer(serializers.Serializer):
    ...
    facebook_messages = serializers.IntegerField(read_only=True)
    viber_messages = serializers.IntegerField(read_only=True)
    vk_messages = serializers.IntegerField(read_only=True)
